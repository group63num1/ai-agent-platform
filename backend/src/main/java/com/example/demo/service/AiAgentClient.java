...
public class AiAgentClient {
    ...
    public void streamChat(Map<String, Object> payload, Consumer<String> eventConsumer) throws IOException {
        ...
        try {
            ...
            int maxStreamMs = config.getMaxStreamDurationMs();
            ...
            try (InputStream inputStream = connection.getInputStream();
                ...
                while ((line = reader.readLine()) != null) {
                    if (maxStreamMs > 0) {
                        ...
                        if (now - startMs > maxStreamMs) {
                            throw new IOException("调用 AI Agent 流式响应超时：maxStreamDurationMs=" + maxStreamMs);
                        }
                    }
