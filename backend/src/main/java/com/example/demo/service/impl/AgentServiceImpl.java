...
public class AgentServiceImpl implements AgentService {
    ...
    private Map<String, Object> buildAiAgentPayload(Agent agent,
        ...
        payload.put("tools", toolResolverService.resolveTools(agent.getUserId(), plugins));
        payload.put("knowledge_bases", knowledgeBaseResolverService.resolveKnowledgeBaseIds(agent.getUserId(), knowledgeBases));
